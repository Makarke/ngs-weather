...
UPD:
Сохранение последнего просмотренного города реализовано путем сохраненния информации в коллекцию lastcity базы данных
Убраны сессии за ненадобностью
Проверка на параметр id в info.php
Все знаки табулации заменены на 4 пробела; изменены конструкции if, for; отформатированны аргументы методов, убраны все символы в непустых строках в соответствии со стандартом PSR
Весь html код вынесен из php
