...
В качестве основной ОС была выбрана Ubuntu (15.04), правда установленная на виртуальной машине, но суть остается верной.
Веб сервер - nginx, в соответствии с заданием.

Для реализации автообновления архива погоды была использованна программа cron, входящая в стандартный пакет unix систем.
